...
<img alt="Jonathan Harris" class="logo-plain logo-plain--hero hero-logo-effect" fetchpriority="high" height="96" loading="eager" src="https://images.jonathan-harris.online/site-logo" width="96"/>
...
<a class="button secondary home-podcast-button" href="/podcast/">Listen to Turing’s Torch</a>
...
<!-- GROWTH:ROUTER END -->'''
    ...
    explore = f'''<section class="section--explore"><div class="wrap"><h2 class="section-label--centered">Explore</h2><div class="grid grid--explore"><article class="card card--explore"><img class="card__brand-icon" src="https://images.jonathan-harris.online/ebooks-image" alt="AI eBooks" loading="lazy" decoding="async" width="72" height="72"/><h3 class="card__title">{count} AI eBooks</h3><p class="card__desc">Plain-English guides covering AI in healthcare, law, banking, manufacturing, education and more.</p><a class="button" href="/ebooks/">Browse catalogue</a></article><article class="card card--explore"><img class="card__brand-icon" src="https://podcast-coverart.jonathan-harris.online/cover-art.png" alt="Turing’s Torch podcast" loading="lazy" decoding="async" width="72" height="72"/><h3 class="card__title">Turing’s Torch Podcast</h3><p class="card__desc">Practical AI analysis with clear context and zero patience for buzzwords.</p><a class="button" href="/podcast/">Listen free</a></article><article class="card card--explore"><img class="card__brand-icon" src="https://images.jonathan-harris.online/hp-newsletter" alt="AI Edge newsletter" loading="lazy" decoding="async" width="72" height="72"/><h3 class="card__title">AI Edge</h3><p class="card__desc">A practical AI briefing plus the free plain-English AI glossary.</p><a class="button" href="/newsletter/">Get the glossary</a></article></div></div></section>'''
...
<div class="wrap hero-logo-stage"><img src="https://images.jonathan-harris.online/site-logo" alt="Jonathan Harris" class="logo-morph hero-logo-effect" loading="eager" fetchpriority="high" width="120" height="120"/>
