...
REQUIRED = {
    ...
    "functions/_shared/cognipal.js": ["x-coginpal-signature", "AIMS_COMMS_HUB_BASE_URL", "COMMS_HUB_COGINPAL_WEBHOOK_SECRET", "BLOG_BUCKET", "R2_RATE_LIMIT_PREFIX", "etagMatches", "rate_limited", "if (!origin) return false"],
    ...
    "wrangler.toml": ["binding     = \"BLOG_BUCKET\"", "bucket_name = \"blog\""],
    "scripts/cognipal-rate-limit.test.mjs": ["session rotation", "FakeR2Bucket", "rate_limited", "origin_rejected", "rate_limiter_unavailable"],
}
