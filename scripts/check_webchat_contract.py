...
REQUIRED = {
    ...
    "wrangler.toml": ["COGNIPAL_RATE_LIMITER", "CogniPalRateLimiter", "script_name = \"cognipal-rate-limit\""],
    "scripts/cognipal-rate-limit.test.mjs": ["session rotation", "FakeDurableObjectNamespace", "CogniPalRateLimiter", "rate_limited", "origin_rejected", "rate_limiter_unavailable"],
}
