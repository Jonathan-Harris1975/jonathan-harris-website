...
class SeoAeoGeoForensicWorkflowTests(unittest.TestCase):
  def test_derives_analysis_url_only_from_expected_callback_route(self):
    self.assertEqual(
      audit.derive_analysis_url("https://zeroth-kara-jonathanharris-3296ed37.koyeb.app/audits/seo-aeo-geo/callback"),
      "https://zeroth-kara-jonathanharris-3296ed37.koyeb.app/audits/seo-aeo-geo/analysis",
    )

  def test_rejects_non_matching_callback_route(self):
    self.assertIsNone(
      audit.derive_analysis_url("https://zeroth-kara-jonathanharris-3296ed37.koyeb.app/audits/mobile-ux/callback")
    )

  def test_override_is_respected_for_manual_dispatches(self):
    self.assertEqual(
      audit.derive_analysis_url(
        "https://zeroth-kara-jonathanharris-3296ed37.koyeb.app/audits/seo-aeo-geo/callback",
  ...
  def test_runtime_callback_config_uses_env_fallbacks(self):
    ...
    try:
      ...
      self.assertEqual(args.callback_url, "https://zeroth-kara-jonathanharris-3296ed37.koyeb.app/audits/seo-aeo-geo/callback")
