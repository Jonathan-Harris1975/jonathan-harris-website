...
def detect_challenge_page(status_code: int, title: str = "", html_text: str = "") -> bool:
    title_norm = (title or "").strip().lower()
    html_norm = (html_text or "").lower()
    ...
    if any(marker in html_norm for marker in html_markers):
        return True

    if "cloudflare" in html_norm and "challenge" in html_norm:
        return True
