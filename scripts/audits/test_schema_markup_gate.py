...
def test_schema_gate_allows_valid_blogposting(tmp_path: Path):
    ...
    html.write_text(
        (
            '<script '
            'type="application/ld+json">{"@context":"https://schema.org","@type":"BlogPosting",'
            '"headline":"Title","description":"Desc","datePublished":"2026-05-17T08:00:00Z",'
            '"author":{"@type":"Person","name":"Jonathan '
            'Harris"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://example.com"}}</script>'
        ),
        encoding="utf-8",
    )
