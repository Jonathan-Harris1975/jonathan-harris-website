...
def main() -> int:
    ...
    try:
        ...
        run_step("Test CogniPal edge rate limiting", ["node", "--test", "scripts/cognipal-rate-limit.test.mjs"])
        run_step("Test Pages crawler alias routing", ["node", "--test", "scripts/pages-routing.test.mjs"])
