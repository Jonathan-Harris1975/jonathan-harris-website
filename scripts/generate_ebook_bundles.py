...
def card(book):
    return f'''<article class="card ebook-card" data-book-slug="{html.escape(book['slug'])}" data-topic="{html.escape(book.get('topic_slug',''))}"><img class="cover" loading="lazy" decoding="async" width="2480" height="3508" src="{html.escape(book['cover'])}" alt="{html.escape(book['title'])} cover"><h2>{html.escape(book['title'])}</h2><p>{html.escape(book['short'])}</p><div class="actions"><a class="button secondary" href="/ebooks/{html.escape(book['slug'])}/" data-bundle-book-click data-book-slug="{html.escape(book['slug'])}" data-placement="reading_path">View book</a><a class="button" href="{html.escape(book['buy_route'])}" data-ebook-amazon data-book-slug="{html.escape(book['slug'])}" data-placement="reading_path">Buy on Amazon</a></div></article>'''
...
def page(bundle):
    ...
    return f'''<!doctype html><html lang="en-GB"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover"/><title>{html.escape(bundle.get('seo_title') or bundle['title'])} | Jonathan Harris</title><meta name="description" content="{html.escape(bundle['summary'])}"><link rel="canonical" href="{canonical}"><meta name="robots" content="index,follow"><script type="application/ld+json">{schema_json}</script>{font_head}<link rel="stylesheet" href="/assets/css/site.css"><link rel="stylesheet" href="/assets/css/ebook-template.css"></head><body class="ebooks-catalogue jh-growth-page" data-page-type="reading_path" data-bundle-slug="{html.escape(bundle['slug'])}">{header}<header class="hero jh-page-hero" data-jh-header-reveal-anchor><div class="wrap"><a class="jh-page-hero__brand" href="/" aria-label="Jonathan Harris home"><img class="jh-page-hero__logo" src="https://images.jonathan-harris.online/site-logo" alt="Jonathan Harris" width="96" height="96" loading="eager" fetchpriority="high" decoding="async"></a><p class="eyebrow">Curated three-book reading path</p><h1>{html.escape(bundle['title'])}</h1><p>{html.escape(bundle['summary'])}</p></div></header><main class="main" id="main"><div class="wrap"><section class="card answer-first"><h2>Why read these books together?</h2><p>Each title tackles a different part of the same decision landscape. Read them as a sequence or pick the one closest to the problem in front of you.</p></section><section class="grid" aria-label="Books in this reading path">{cards}</section><section class="jh-journey-panel"><h2>Where should you go next?</h2><div class="jh-journey-actions"><a href="/bundles/">All reading paths</a><a href="/ebooks/">Full eBook catalogue</a><a href="/topics/">Topic guides</a></div></section></div></main>{footer}<script defer src="/assets/js/site-ui.min.js"></script></body></html>'''
