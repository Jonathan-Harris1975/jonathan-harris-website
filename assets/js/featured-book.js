...
(function(){
  ...
  async function render() {
    ...
    var featuredSrcset = buildSameSourceSrcset(b.cover, [400, 800, 1200]);
    if (featuredSrcset) {
      setAttr("featuredEbookCover", "srcset", featuredSrcset);
      setAttr("featuredEbookCover", "sizes", "(min-width: 1100px) 180px, (min-width: 768px) 28vw, 50vw");
    } else {
      removeAttr("featuredEbookCover", "srcset");
      removeAttr("featuredEbookCover", "sizes");
    }
